...
const unsigned char  mask[7] =
{	1,3,7,15,31,63,127}; //!< Lookup table -> mask
const unsigned char  power[7] =
{	128,64,32,16,8,4,2}; //!< Lookup table -> 2^( 7 - i )

/*! \brief ZIP_compress will take a user defined text code it into the PDU format
 *
 ...
 *
 */
int ZIP_compress(unsigned char *in, unsigned char *discarded,
		unsigned char ret[])
{
